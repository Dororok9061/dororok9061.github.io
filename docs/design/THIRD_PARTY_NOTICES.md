...
|---|---|---|---|
| `fpga-architecture.*` | `fpga-delay-logic-design-verification/docs/assets/en/architecture/architecture_evolution.png` | `c6ad33984642281664b93f6208d8880467343ce5` | User-owned project documentation; repository license not detected |
| `radar-hardware.*` | `fmcw-radar-aoac-cardiac-analysis/docs/assets/photos/experiment/radar_experiment_photo_collage.webp` | `86d97c55f21cf469e67de4acc0b91b43089de0c3` | Original project evidence; MIT applies to original analysis/docs unless otherwise stated |
...
## Referenced product names

GitHub, Jekyll, Quartus, Cadence, STM32, ESP32, Raspberry Pi, MATLAB, PSIM,
PowerWorld, and other product names remain trademarks of their respective
owners. Their mention does not imply endorsement.
